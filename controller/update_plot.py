...
# @app.callback(
#     Output('confirm-run', 'is_open'),
#     Output('confirm-run-body', 'children'),
#     # MultiplexerOutput("push-notification", "data"),

#     Input("dim-run-btn", "n_clicks"),
#     Input("label-run-btn", "n_clicks"),
#     Input("main-find-de-genes-btn", "n_clicks"),
#     Input("side-find-de-genes-btn", "n_clicks"),

#     State("active-plot", "data"),
#     State("label-tabs", "active_tab"),
#     prevent_initial_call=True
# )
# def notify_time(n1, n2, n3, n4, actp, actt):
...
#     n_cells, n_feats = dbroot.adatas[an]['adata'].shape
#     msg = None
...
#         if n_cells > 50_000:
#             msg = "This might take a while (5+ mins)..."
#         elif n_cells > 10_000:
#             msg = "This might take a few minutes (1-5 mins)..."
#         elif n_cells > 5_000:
#             msg = "This will take about a minute..."
...
#         elif actt == 'lbt':
#             if n_cells > 50_000:
#                 msg = "This might take a long time (30+ mins)..."
#             elif n_cells > 10_000:
#                 msg = "This might take a while (5-30 mins)..."
#             elif n_cells > 5_000:
#                 msg = "This might take a few minutes (5+ mins)..."
#     elif button_id == "main-find-de-genes-btn" or\
#             button_id == "side-find-de-genes-btn":
#         if n_cells > 50_000:
#             msg = "This might take a while (1-5 mins)..."
#         elif n_cells > 10_000:
#             msg = "This will take about a minute..."
